...
M.prototype.findByName = function (query) {
...
M.prototype.findByNo = function (query) {
    let array = Array.from(this.list)
    let newArray = []
    array.forEach(item =>{
        var t = item.options.filter(op=>{
...
M.prototype.findByPhone = function (query) {
    let array = Array.from(this.list)
    let newArray = []
    array.forEach(item =>{
        var t = item.options.filter(op=>{
...
M.prototype.findByInitial = function (query) {
    let array       = Array.from(this.list)
    let newArray    = []
    array.forEach(item =>{
        var t = item.options.filter(op=>{
...
M.prototype.findByVal = function (query) {
    let array       = Array.from(this.list)
    let res         = null
    array.forEach(item =>{
