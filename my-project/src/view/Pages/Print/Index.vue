        ...
        computed:{
            ...
            rate:function () {
                ...
                if(limit>=30 && limit <= 90)
                    res = 6.9/12   //月利率 百分之 0.6   7.2% 年化
                if(limit>=100 && limit <= 270)
                    res = 7.5/12 //  月利率 百分之 0.625   7.5% 年化
                if(limit>=300 && limit <= 365)
                    res = 7.8/12 //  月利率 百分之 0.6666   8% 年化
            ...
            list:function () {
                ...
                if((that.limit>=100 && that.limit <= 270)||(that.limit>=300 && that.limit <= 365)){
