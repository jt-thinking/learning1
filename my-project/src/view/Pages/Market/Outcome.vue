            ...
            <div class="search-box">
                <el-form   :model="formInline" label-width="66px" >
                    ...
                    <el-form-item label="状态">
                        <el-select size="small" class="status" label-width="40px"  v-model="search.status" placeholder="请选择条件">
                            <!--// 状态 0-未还款 1-已还款 2-部分还款 3-逾期未还款  4-逾期已还款 5-违约 6-已兑付-->
                            <el-option :label="'全部'" :value="null"></el-option>
                            <el-option :label="'未还款'" value="0"></el-option>
                            <el-option :label="'已还款未兑付'" value="1"></el-option>
        ...
        <div class="table">
            <el-table
                ...
                <el-table-column
                        ...
                        width="100">
                    <template scope="scope">
                        <span>{{ scope.row.feeAmt | moneyFormat }}</span>
                    </template>
                </el-table-column>
                <el-table-column
                        align="center"
                ...
                width="120">
                <template scope="scope">
                <span>{{ scope.row.accoutAmount | moneyFormat }}</span>
                </template>
                </el-table-column>
                <el-table-column
                        align="center"
                        ...
                        width="120">
                    <template scope="scope">
                        <span>{{ scope.row.lendDate | dateFormat }}</span>
                    </template>
                </el-table-column>
                <el-table-column
                        align="center"
...
//                    }, 200);
            ...
            doSearch(){
                let that        = this
                let url         = Vue.agent.root + '/statistics/plan/selectLoanPlan'
                var reqData     = {
            ...
            doExport(){
                let that        = this
                let url         = Vue.agent.root + '/statistics/plan/loan/excel'
                let fileName    = "还款计划" + moment().format("YYYY-MM-DD hh:mm:ss")
                var reqData     = {
                    funcId:that.funcId
                }
...
<style lang="scss">
    @import 'src/scss/pages/market/outcome.scss';
</style>