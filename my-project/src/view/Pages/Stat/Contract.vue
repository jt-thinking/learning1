        ...
        <div class="stat-box">
            <div class="search-box">
                <el-form   :model="formInline" label-width="66px" >
                    ...
                    <!--<el-form-item label="首笔" label-width="50px">-->
...
//                    }, 200);
            ...
            doExport(){
                ...
                let fileName    = "合同查询" + moment().format("YYYY-MM-DD hh:mm:ss")
                var reqData     = {
                    funcId:that.funcId
                }
...
<style lang="scss">
    @import 'src/scss/pages/stat/contract.scss';
</style>